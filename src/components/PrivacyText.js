...
export default function PrivacyText() {
    return (
        ...
        <article className="section">
            ...
            <p>BookyBooks ("us", "we", or "our") operates the https://bookybooks.org website (hereinafter referred to as the "Service").</p>
            ...
            <ul>
                <li>
                    ...
                    <p>Service is the https://bookybooks.org website operated by BookyBooks</p>
                </li>
                <li>
            ...
            <p>BookyBooks uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>BookyBooks will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h2>Disclosure Of Data</h2>

            <h3>Legal Requirements</h3>
            <p>BookyBooks may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of BookyBooks</li>
            ...
            <ul>
                <li>
                    ...
                    <p>Google Analytics is a web analytics service. You can learn more about Google's Privacy Policy here: <a href="https://policies.google.com/">https://policies.google.com/</a></p>
                </li>
            </ul>
            ...
            <ul>
                <li>By email: julian.johannesen@gmail.com</li>
                <li>By visiting this page on our website: https://bookybooks.org/contact</li>
            ...
            <p>Google Play - Privacy Policy for Books<br />
